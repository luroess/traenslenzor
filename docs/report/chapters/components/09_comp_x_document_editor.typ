...
Since the #gls("llm") cannot determine when the image should be rerendered, the tool provides a message prompting the #gls("llm") to trigger image rerendering when necessary.
