...
#warning-note("Should we mention, that special handling in the prompt for this tool was required for it to work reliably?")

#warning-note("Add image of changed rendered image?")
